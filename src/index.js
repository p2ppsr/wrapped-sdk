...
const documentAvailable = (typeof window === 'object' && typeof document === 'object')
...
const showModal = () => {
  if (!documentAvailable) {
    const e = new Error('The operation you are trying to complete can only work if you have a MetaNet identity set up. You can either abort the operation, or set up a MetaNet identity before trying again.')
    e.code = 'ERR_NO_METANET_IDENTITY'
    throw e
  }
